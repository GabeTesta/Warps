...
namespace Warps.Trackers
{
	public class GuideCombTracker : ITracker
	{
		...
		public bool IsTracking { get { return !m_temp.IsEqual(m_guide); } }
		...
		internal void OnCombUpdated(object sender, EventArgs<Vect2[]> e)
		{
			m_temp.FitComb(e.Value);
			UpdateViewCurve(false);
		}
